          ...
          const SnapItemRow = ({ name, data }) => {
            ...
            return (
              <div style={{ display: "grid", gridTemplateColumns: snapItemCols, gap: 4, padding: "3px 0", alignItems: "center", fontSize: 12 }}>
                ...
                <select value={data.c || ""} onChange={e => upSnapItem(name, "c", e.target.value)} style={{ fontSize: 10, border: "1px solid var(--input-border, #ddd)", borderRadius: 4, padding: "2px 3px" }}>
                  <option value="">—</option>
                  ...
                  <Card style={{ marginBottom: 20 }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                      ...
                      <div><label style={{ fontSize: 11, fontWeight: 700, color: "#999" }}>Filing Status</label>
                        <select value={snapFiling} onChange={e => { upSnap("fil", e.target.value); const n = [...snapshots]; const s = { ...n[viewingSnap] }; if (s.fullState) s.fullState = { ...s.fullState, fil: e.target.value }; n[viewingSnap] = recalcSnap(s); setSnapshots(n); }} style={{ width: "100%", border: "2px solid var(--input-border, #e0e0e0)", borderRadius: 8, padding: 8, fontSize: 13, background: "var(--input-bg, #fafafa)" }}>
