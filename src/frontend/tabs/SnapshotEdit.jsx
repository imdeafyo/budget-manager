...
import { evalF, calcFed, getMarg, calcStateTax } from "../utils/calc.js";
...
export default function SnapshotEdit({
  viewingSnap, setViewingSnap, snapshots, setSnapshots, recalcSnap,
  p1Name, p2Name, mob, cats, savCats,
  snapVisCols, setSnapVisCols, snapTab, setSnapTab,
  restoreConfirm, setRestoreConfirm, setTab,
  tax, fil, allTaxDB,
}) {
