  ...
  return (
    <div>
      ...
      <Card style={{ overflowX: "auto" }}>
        ...
        {!collapsed.preSav && <>{(C.cHsaW + C.kHsaW > 0) && (() => { const v = C.cHsaW + C.kHsaW; const empA = (C.cHsaEmployerA || 0) + (C.kHsaEmployerA || 0); return <Row key="hsa" label={"💰 HSA" + (empA > 0 ? ` (+ ${fmt(empA)}/yr employer)` : "")} wk={v} mo={moC(v)} y48={y4(v)} y52={y5(v)} color="var(--c-presav, #1ABC9C)" />; })()}
        {showPerPerson && (C.cHsaW > 0 || C.kHsaW > 0) && <div key="hsp"><Row label={`  ↳ ${p1Name} HSA` + ((C.cHsaEmployerA || 0) > 0 ? ` (+ ${fmt(C.cHsaEmployerA)}/yr employer)` : "")} wk={C.cHsaW} mo={moC(C.cHsaW)} y48={y4(C.cHsaW)} y52={y5(C.cHsaW)} color="var(--c-presav, #48C9B0)" /><Row label={`  ↳ ${p2Name} HSA` + ((C.kHsaEmployerA || 0) > 0 ? ` (+ ${fmt(C.kHsaEmployerA)}/yr employer)` : "")} wk={C.kHsaW} mo={moC(C.kHsaW)} y48={y4(C.kHsaW)} y52={y5(C.kHsaW)} color="var(--c-presav, #48C9B0)" /></div>}
        ...
        {(() => { const hsaW = C.cHsaW + C.kHsaW; const preTax401 = C.c4preW + C.k4preW; const iraTradW = (C.cIraTradW || 0) + (C.kIraTradW || 0); const total = hsaW + preTax401 + iraTradW; return total > 0 ? <Row label="Total Pre-Tax Savings" wk={total} mo={moC(total)} y48={y4(total)} y52={y5(total)} bold border color="var(--c-presav, #1ABC9C)" /> : null; })()}
