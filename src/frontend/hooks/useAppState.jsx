...
export default function useAppState() {
  ...
  const VALID_SUBTABS = { budget: ["live", "milestones", "compare"], charts: ["trends", "forecast", "advanced", "loans"] };
  ...
  const [dupScanCrossAccount, setDupScanCrossAccount] = useState(false);
  ...
  return {
    ...
    dupScanCrossAccount, setDupScanCrossAccount,
