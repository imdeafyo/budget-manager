...
export default function useAppState() {
  ...
  const [showExcludedDuplicates, setShowExcludedDuplicates] = useState(false);
  ...
  return {
    ...
    showExcludedDuplicates, setShowExcludedDuplicates,
