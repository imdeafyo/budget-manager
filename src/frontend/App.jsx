          ...
          <div>
            <Card style={{ marginBottom: 20 }}>
              ...
              <div style={{ display: "flex", gap: 8, alignItems: "flex-end", flexWrap: "wrap" }}>
                <div style={{ flex: "0 0 auto", width: mob ? "100%" : 150 }}><label style={{ fontSize: 11, fontWeight: 700, color: "#999" }}>Date</label>
                ...
                <div style={{ flex: "1 1 120px", minWidth: 0 }}><label style={{ fontSize: 11, fontWeight: 700, color: "#999" }}>Label</label>
