  ...
  return (
    ...
    <div style={{ minHeight: "100vh", background: S.bg, fontFamily: "'DM Sans',sans-serif", color: S.tx }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: S.mob ? "6px 12px 0" : "10px 20px 0" }}>
          ...
          {(S.tab === "budget" || S.tab === "charts") && (
            <div style={{ display: "flex", gap: 6, padding: "6px 0 4px", overflowX: "auto" }}>
              ...
              {S.tab === "charts" && [["trends", "Trends"], ["forecast", "Simple"], ["advanced", "Advanced"], ["loans", "Loans"]].map(([k, l]) => {
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: S.mob ? "12px 10px 60px" : "24px 20px 60px" }}>
        ...
        {S.isDeploy && S.tab === "insights" && <InsightsTab mob={S.mob} provider={S.insightsProvider} />}
        ...
        {S.tab === "charts" && S.chartsSubtab === "advanced" && <AdvancedForecastTab mob={S.mob} forecast={S.forecast} setForecast={S.setForecast} tax={S.tax} setTax={S.setTax} p1Name={S.p1Name} p2Name={S.p2Name} cSal={S.cSal} kSal={S.kSal} c4pre={S.c4pre} c4ro={S.c4ro} k4pre={S.k4pre} k4ro={S.k4ro} cIraTrad={S.cIraTrad} cIraRoth={S.cIraRoth} kIraTrad={S.kIraTrad} kIraRoth={S.kIraRoth} cHsa={S.cHsa} kHsa={S.kHsa} cHsaEmployer={S.cHsaEmployer} kHsaEmployer={S.kHsaEmployer} preDed={S.preDed} hsaEmployerMatchAnnual={S.tax?.hsaEmployerMatch || 0} tExpW={S.tExpW} tSavW={S.tSavW} remW={S.remW} transactions={S.transactions} cats={S.cats} savCats={S.savCats} transferCats={S.transferCats} C={S.C} exp={S.exp} sav={S.sav} />}

        {S.tab === "charts" && S.chartsSubtab === "loans" && <LoansTab mob={S.mob} forecast={S.forecast} setForecast={S.setForecast} />}
        ...
        {S.tab === "transactions" && <TransactionsTab
          ...
          dupScanCrossAccount={S.dupScanCrossAccount}
          showExcludedDuplicates={S.showExcludedDuplicates}
        ...
        {S.tab === "prefs" && <SettingsTab
          mob={S.mob}
          isDeploy={S.isDeploy}
          insightsProvider={S.insightsProvider}
          setInsightsProvider={S.setInsightsProvider}
          transactionColumns={S.transactionColumns}
          ...
          dupScanCrossAccount={S.dupScanCrossAccount}
          setDupScanCrossAccount={S.setDupScanCrossAccount}
          showExcludedDuplicates={S.showExcludedDuplicates}
          setShowExcludedDuplicates={S.setShowExcludedDuplicates}
          outlierSettings={S.outlierSettings}
