  ...
  return (
    ...
    <div style={{ minHeight: "100vh", background: S.bg, fontFamily: "'DM Sans',sans-serif", color: S.tx }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: S.mob ? "12px 10px 60px" : "24px 20px 60px" }}>
        ...
        {/* ═══ INCOME ═══ */}
        {S.tab === "settings" && <IncomeTab mob={S.mob} p1Name={S.p1Name} setP1Name={S.setP1Name} p2Name={S.p2Name} setP2Name={S.setP2Name} cSal={S.cSal} setCS={S.setCS} kSal={S.kSal} setKS={S.setKS} cEaip={S.cEaip} setCE={S.setCE} kEaip={S.kEaip} setKE={S.setKE} fil={S.fil} setFil={S.setFil} c4pre={S.c4pre} setC4pre={S.setC4pre} c4ro={S.c4ro} setC4ro={S.setC4ro} k4pre={S.k4pre} setK4pre={S.setK4pre} k4ro={S.k4ro} setK4ro={S.setK4ro} tax={S.tax} upTax={S.upTax} cHsaAnn={S.cHsaAnn} setCHsaAnn={S.setCHsaAnn} kHsaAnn={S.kHsaAnn} setKHsaAnn={S.setKHsaAnn} preDed={S.preDed} setPreDed={S.setPreDed} postDed={S.postDed} setPostDed={S.setPostDed} C={S.C} />}
